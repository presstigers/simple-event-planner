    ...
    var GMapsLatLonPicker = (function () {
        ...
        var publicfunc = {
            ...
            init: function (object) {
                ...
                // Trigger idle event on Location Tab click    
                $("#location-tab,#location-map").on("click", function () {
                    google.maps.event.trigger(_self.vars.map, 'idle');
                });
